...
export class StreamingMessageParser {
  ...
  constructor(private _options: StreamingMessageParserOptions = {}) {
    this._options.callbacks = {
      onArtifactOpen: (data) => {
        console.log("[Parser] Artifact Open:", data);
        this._options.callbacks?.onArtifactOpen?.(data);
      },
      onArtifactClose: (data) => {
        console.log("[Parser] Artifact Close:", data);
        this._options.callbacks?.onArtifactClose?.(data);
      },
      onActionOpen: (data) => {
        console.log("[Parser] Action Open:", data);
        this._options.callbacks?.onActionOpen?.(data);
      },
      onActionClose: (data) => {
        console.log("[Parser] Action Close:", data);
  ...
  #parseActionTag(
    ...
    if (actionType === "file") {
      ...
      console.warn(`Unknown action type '${actionType as string}'`);
    }
